...
public class ColumnsClient2DAO extends EgovClient2AbstractDAO {
	...
	public Map<String, Object> executeQuery(String sqlStr) throws Exception {
		...
		try {
			...
			if (resultSet.next()) {
				...
				List<ColumnsVO> tableColumnsVOList = new ArrayList<ColumnsVO>();
				List<Map<String, String>> columnMapList = new ArrayList<Map<String, String>>();
				for (int i = 0; i < resultSetMetaData.getColumnCount(); i++) {
					int colnum = i + 1;
					ColumnsVO tableColumnsVO = new ColumnsVO();
