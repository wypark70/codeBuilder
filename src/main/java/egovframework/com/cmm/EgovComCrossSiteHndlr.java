...
public class EgovComCrossSiteHndlr extends BodyTagSupport {
	...
	/**
	 * Outputs <tt>text</tt> to <tt>pageContext</tt>'s current JspWriter. If <tt>escapeXml</tt> is true, performs the following substring replacements (to facilitate output to XML/HTML pages):
	 *
	 * & -> &amp; < -> &lt; > -> &gt; " -> &#034; ' -> &#039;
	 *
	...
	/**
	 *
	 * Optimized to create no extra objects and write directly to the JspWriter using blocks of escaped and unescaped characters
	 *
	 */
